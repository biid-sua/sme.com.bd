...
//----------------------------Add Product--------------------------
if (isset($_POST['UpdateProdDetails']))
{
	$PDId=$_POST['PDId'];
	$LPId=$_POST['LPId'];
	...
	$sqlPD=mysql_query("UPDATE proddetails SET LPId='$LPId', LoanPurpose='$LoanPurpose', Qualification='$Qualification', ImpPapers='$ImpPapers', Others='$Others' WHERE PDId='$PDId'");
        ...
        <td width="80%"><table width="100%" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td><form id="form1" name="form1" method="post" action="">
				...
				<?php 
					$sqlD=mysql_query("SELECT * FROM proddetails WHERE PDId='$_GET[PDId]'");
					$dtD=mysql_fetch_array($sqlD);
				?>
                  <tr>
                    <td colspan="3"><h4>Edit  Product Details </h4></td>
                  </tr>
                  <tr>
                    ...
                    <td width="74%"><select name="LPId" id="LPId">
                        ...
                        <?php
							...
							{
						 ?>
                        <option value="<?php echo $dtLP['LPId'];?>" <?php if ($dtLP['LPId']==$dtD['LPId']) echo "SELECTED"; ?>> <?php echo $dtLP['ProductName'];?> </option>
                        <?php } ?>
                    </select></td>
                  </tr>
                  <tr>
                    ...
                    <td><textarea name="LoanPurpose" cols="45" rows="7" id="LoanPurpose"><?php echo $dtD['LoanPurpose'];?></textarea></td>
                  </tr>
                  <tr>
                    <td valign="top"><div align="right">Qualification for Loan </div></td>
                    <td valign="top"><div align="center"><strong>:</strong></div></td>
                    <td><textarea name="Qualification" cols="45" rows="7" id="Qualification"><?php echo $dtD['Qualification'];?></textarea></td>
                  </tr>
                  <tr>
                    <td valign="top"><div align="right">Important Papers </div></td>
                    <td valign="top"><div align="center"><strong>:</strong></div></td>
                    <td><textarea name="ImpPapers" cols="45" rows="7" id="ImpPapers"><?php echo $dtD['ImpPapers'];?></textarea></td>
                  </tr>
                  <tr>
                    <td valign="top"><div align="right">Others</div></td>
                    <td valign="top"><div align="center"><strong>:</strong></div></td>
                    <td><textarea name="Others" cols="45" rows="7" id="Others"><?php echo $dtD['Others'];?></textarea></td>
                  </tr>
                  <tr>
                    <td><div align="right"></div></td>
                    <td>&nbsp;</td>
                    <td><input name="UpdateProdDetails" type="submit" id="UpdateProdDetails" value="Edit Product Details" onclick="return Empty_field('LPId,LoanPurpose,Qualification,ImpPapers,LoanAmount,InterestRate','EditLPDetail.php')" />
                      <input name="PDId" type="hidden" id="PDId" value="<?php echo $dtD['PDId']; ?>" /></td>
                  </tr>
                  <tr>
                    <td><div align="right"></div></td>
                    <td>&nbsp;</td>
