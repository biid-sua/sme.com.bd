...
if (!empty($TempPhoto)) 
	{
		$result=mysql_query("SELECT * FROM omp WHERE ProductId='$_POST[ProductId]'");
...
//----------------- Update DB ------------------------------------------
	$result=mysql_query("UPDATE omp SET Product='$Product', Details='$Details', Producer='$Producer', ProducerId='$ProducerId', Cost='$Cost', Location='$Location', Photo='$FileName', Status='$Status', Date='$Date' WHERE ProductId='$_POST[ProductId]'"); 
          ...
          <tr>
            <td><form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return validemail()">
              <table width="100%" border="0" cellspacing="1" cellpadding="2">
              	<?php 
					$sql=mysql_query("SELECT * FROM omp WHERE ProductId='$_GET[ProductId]'");
					$dtProd=mysql_fetch_array($sql);
					$Status=$dtProd['Status'];
					$ProducerId=$dtProd['ProducerId'];
						$sqlP=mysql_query("SELECT * FROM producer WHERE ProducerId='$ProducerId'");
						$dtProducer=mysql_fetch_array($sqlP);
			    ?>
                <tr>
                  ...
                  <td width="69%"><input name="Product" type="text" class="text" id="Product" value="<?=$dtProd['Product'];?>" size="48" />
                    *</td>
                </tr>
                <tr>
                  <td><div align="right"> Details</div></td>
                  <td><div align="center">:</div></td>
                  <td><textarea name="Details" cols="45" rows="5" class="text" id="Details"><?=$dtProd['Details'];?>
                  </textarea>
                    *</td>
                </tr>
                <tr>
                  ...
                  <td><div align="center">:</div></td>
                  <td><input name="Producer" type="text" id="Producer" value="<?=$dtProducer['Producer'];?>" size="46"  onkeyup="lookup(this.value);" onblur="fillName();"/>
                ...
                <tr>
                  ...
                  <td><div align="center">:</div></td>
                  <td><input name="Cost" type="text" class="text" id="Cost" value="<?=$dtProd['Cost'];?>" size="48" /></td>
                </tr>
                <tr>
                  ...
                  <td><div align="center">:</div></td>
                  <td><?=$dtProd['Photo'];?><br />
                  <input name="filename" type="file" id="filename" size="34" /></td>
                </tr>
                <tr>
                  <td><div align="right">Availablity Location</div></td>
                  <td><div align="center">:</div></td>
                  <td><input name="Location" type="text" class="text" id="Location" value="<?=$dtProd['Location'];?>" size="48" />
                    *</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><div align="center"></div></td>
                  <td><input name="UpdateProduct" type="submit" id="UpdateProduct" onclick="return Empty_field('Product,Details,Producer,Location','EditProduct.php')" value="Edit Product" />
                    <input name="ProductId" type="hidden" id="ProductId" value="<?=$_GET[ProductId];?>" />
                    <input name="PhotoName1" type="hidden" id="PhotoName1" value="<?=$dtProd['Photo'];?>" /></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
