...
//---------------------------Insert Category--------------------------------
if (isset($_POST['AddLSrc'])) 
 {
	$LSrcName=$_POST['LSrcName'];

	$result=mysql_query("SELECT * FROM lsource WHERE LSrcName='$LSrcName'")
			...
			if ($num < 1)
				{
					...
					$query = "INSERT INTO lsource (LSrcName) VALUES ('$LSrcName')";
  ...
  <tr>
    <td valign="top" class="mainpadding"><table width="100%" border="0" cellspacing="1" cellpadding="2">
      <tr>
        ...
        <td width="80%" valign="top"><table width="99%" border="0" align="center" cellpadding="2" cellspacing="2">
          <tr>
            <td valign="top" class="mainpadding"><h4>Source </h4></td>
          </tr>
          <tr>
            <td><form id="form1" name="form1" method="post" action="">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="39%"><input name="LSrcName" type="text" id="LSrcName" size="30" /></td>
                  <td width="41%"><input name="AddLSrc" type="submit" id="AddLSrc" value="যোগ করুন" onclick="return Empty_field('LSrcName','LoanSource.php')" /></td>
                </tr>
              </table>
                        </form>            </td>
          </tr>
