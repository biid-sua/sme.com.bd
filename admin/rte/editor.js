...
WYSIWYG_Editor.prototype._display_editor = function (){
    ...
    if(this.font_format_toolbar1){
        ...
        document.write('           <option value="solaimanlipi">SolaimanLipi</option>');
		document.write('           <option value="Vrinda">Vrinda</option>');
        ...
        document.write('           <option value="-2">x-Small (10px)</option>');
        document.write('           <option value="-1">Small (12px)</option>');
        document.write('           <option value="+0">Medium (16px)</option>');
        document.write('           <option value="+1">Large (18px)</option>');
        document.write('           <option value="+2">X Large (24px)</option>');
        document.write('          </select>');
...
WYSIWYG_Editor.prototype.insertImage = function (){
    this.imagePopUp=window.open(this.site_path+'/ImagePopup.php?page_title='+this.page_title,'','width=620,height=500,resizable=1,scrollbars=yes');
